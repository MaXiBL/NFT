  ...
  setup(props, context) {
    ...
    const tiny = reactive({
      ...
      init: {
        ...
        content_style: "p {color:#000000; padding: 3px}",
        ...
        toolbar: [
          "forecolor backcolor bold italic underline    | alignleft aligncenter alignright alignjustify outdent indent | bullist numlist   ",
          " ",
        ],
        // 所有配置
